...
class Program
    {
        ...
        {
            var y = new Fraction(1, 7);
            var x = new Fraction(3, 7);
            var z = new Fraction(8, 9);
            var b = new Fraction(2, 7);
            var u = new Fraction(1, 5);
            Fraction[] nums = new Fraction[] { y, x, z, b, u };
            ...
            Console.WriteLine("================================");
            Console.WriteLine("Вывод отсортированного (по знаменателю) массива: ");
            var query2 = from q in nums
                         orderby q.Denominator // Сортировка
                         select q.ToString();
            ...
            Console.WriteLine(x < y);
            Console.WriteLine(u == 0.25);
            Console.WriteLine(z >= 0.8);
